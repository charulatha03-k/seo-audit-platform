...
import { Activity, ArrowRight, CheckCircle2, Lock, Mail, Sun, Moon } from 'lucide-react';
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 relative">
        ...
        <div className="w-full max-w-md relative z-10">
          <div className="absolute top-0 right-0 -mt-8 -mr-8">
            <button
              type="button"
              className="p-2 text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 transition-colors bg-white/10 rounded-full"
              onClick={toggleTheme}
            >
          ...
          <div className="glass-card p-8 rounded-2xl">
            ...
            <div className="mt-8">
              ...
              <div className="mt-6 grid grid-cols-3 gap-3">
                <button className="w-full inline-flex justify-center items-center py-2.5 px-2 border border-border/50 rounded-xl shadow-sm bg-card text-sm font-medium text-foreground hover:bg-muted transition-colors">
                ...
                <button className="w-full inline-flex justify-center items-center py-2.5 px-2 border border-border/50 rounded-xl shadow-sm bg-card text-sm font-medium text-foreground hover:bg-muted transition-colors">
                  <svg className="w-5 h-5 lg:mr-2" fill="currentColor" viewBox="0 0 24 24">
                ...
                <button className="w-full inline-flex justify-center items-center py-2.5 px-2 border border-border/50 rounded-xl shadow-sm bg-card text-sm font-medium text-foreground hover:bg-muted transition-colors">
                  <svg className="w-5 h-5 lg:mr-2" viewBox="0 0 24 24" fill="none">
